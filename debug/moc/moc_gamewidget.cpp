...
Q_CONSTINIT static const qt_meta_stringdata_gameWidget_t qt_meta_stringdata_gameWidget = {
    {
        ...
        QT_MOC_LITERAL(11, 12),  // "returnSignal"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 10),  // "returnPush"
        QT_MOC_LITERAL(36, 12)   // "chessOneByAi"
    },
    "gameWidget",
    "returnSignal",
    "",
...
void gameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &gameWidget::returnSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
